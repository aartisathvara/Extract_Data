...
output_file_csv = open('house.csv', 'w')
csvwriter = csv.DictWriter(output_file_csv, delimiter=',', fieldnames=fields)
...
while True:
    ...
    url = "https://www.justdial.com/Delhi/House-On-Rent/nct-10192844/page-%s" % (page_number)
    print(url)
